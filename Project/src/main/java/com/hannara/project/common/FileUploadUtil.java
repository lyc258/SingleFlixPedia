...
public class FileUploadUtil {
	...
	public static void upload(String contextPath, List<MultipartFile> fileList, List<String> fileNameList) {
		...
		if (fileList != null && fileList.size() > 0) {
			for (MultipartFile multipartFile : fileList) {
				...
				try {
					...
					//System.out.println("0000000000000000000000000" + newFileName);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
